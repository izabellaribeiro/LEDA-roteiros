...
public class StudentDoubleLinkedListTest extends StudentLinkedListTest {
	...
	public void myTestInsertFirst() {
		...
		assertArrayEquals(new Integer[] { 4 }, lista2.toArray());

		((DoubleLinkedList<Integer>) lista2).insertFirst(2);
		((DoubleLinkedList<Integer>) lista2).insertFirst(7);
		assertArrayEquals(new Integer[] { 7,2,4 }, lista2.toArray());

		((DoubleLinkedList<Integer>) lista2).insertFirst(0);
		((DoubleLinkedList<Integer>) lista2).insertFirst(1);
		assertArrayEquals(new Integer[] { 1,0,7,2,4 }, lista2.toArray());

		lista2.insert(3);
		lista2.insert(8);
		lista2.insert(5);
		assertArrayEquals(new Integer[] { 1,0,7,2,4,3,8,5 }, lista2.toArray());

		((DoubleLinkedList<Integer>) lista2).insertFirst(12);
		assertArrayEquals(new Integer[] { 12,1,0,7,2,4,3,8,5 }, lista2.toArray());
	...
	public void myTestRemoveFirst() {
		...
		assertArrayEquals(new Integer[] { 1,2,3,4,5,6 }, lista2.toArray());
		((DoubleLinkedList<Integer>) lista2).removeFirst();
		assertArrayEquals(new Integer[] { 2,3,4,5,6 }, lista2.toArray());

		((DoubleLinkedList<Integer>) lista2).removeFirst();
		((DoubleLinkedList<Integer>) lista2).removeFirst();
		assertArrayEquals(new Integer[] { 4,5,6 }, lista2.toArray());

		((DoubleLinkedList<Integer>) lista2).removeFirst();
		((DoubleLinkedList<Integer>) lista2).removeFirst();
		assertArrayEquals(new Integer[] { 6 }, lista2.toArray());
	...
	public void myTestRemoveLast() {
		...
		assertArrayEquals(new Integer[] { 1,2,3,4,5 }, lista2.toArray());

		((DoubleLinkedList<Integer>) lista2).removeLast();
		((DoubleLinkedList<Integer>) lista2).removeLast();
		assertArrayEquals(new Integer[] { 1,2,3 }, lista2.toArray());
